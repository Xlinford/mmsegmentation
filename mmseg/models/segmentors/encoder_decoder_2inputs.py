...
from .base2inputs import BaseSegmentor


@SEGMENTORS.register_module()
class EncoderDecoder2Inputs(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(EncoderDecoder2Inputs, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        super(EncoderDecoder2Inputs, self).init_weights(pretrained)
